...
def get_unet(num_color_component, dimension):
    ...
    up6 = keras.layers.merge([UpSampling2D(size=(2, 2))(conv5), conv4], mode='concat', concat_axis=1)
    conv6 = Convolution2D(256, 3, 3, activation='relu', border_mode='same')(up6)
    conv6 = Convolution2D(256, 3, 3, activation='relu', border_mode='same')(conv6)

    up7 = keras.layers.merge([UpSampling2D(size=(2, 2))(conv6), conv3], mode='concat', concat_axis=1)
    ...
    up9 = keras.layers.merge([UpSampling2D(size=(2, 2))(conv8), conv1], mode='concat', concat_axis=1)
